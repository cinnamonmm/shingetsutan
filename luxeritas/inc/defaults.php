...
*/
		...
		if( isset( $mods['lazyload_contents'] ) ) {
			if( $this->_is_singular === true || ( isset( $mods['list_view'] ) && $mods['list_view'] === 'content' ) || ( isset( $mods['sticky_no_excerpt'] ) && $mods['sticky_no_excerpt'] && is_sticky() === true ) ) {
			}
			else {
