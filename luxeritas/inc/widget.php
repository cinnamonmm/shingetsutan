				...
				if( empty( $thumbnail ) ) {
					...
					if( $post_thumbnail === false && isset( $luxe['no_img'] ) ) {
						...
						if( $attachment_id !== false ) {
							$post_thumbnail = true;
							$echo = true;
							$aria_label = 'aria_label="No Imaage"';
						}
					}
...
?><figure class="term"><a href="<?php the_permalink() ?>" <?php echo $aria_label; ?>><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/no-img-100x100.png" alt="No Image" title="No Image" width="100" height="100" /><?php
					}
?></a>
</figure>
<?php
