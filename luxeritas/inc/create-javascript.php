...
SCRIPT;
		...
		'#layer li[class*=\"has-wrap-menu\"] > a::before{content:\"\\{$fa_caret_square_down}\";font-weight:400;margin-left:-4px};}' /* margin-left:-4px は Fontawesome の位置調整 */
...
SCRIPT;
		...
		Array.prototype.forEach.call( layer, function(e) {
			e.addEventListener("click", function(F) {
				...
				} F.preventDefault() /*, F.stopImmediatePropagation()*//* ラッパーメニュー用にリスナーを追加したので、stopImmediatePropagation 削除 */;
			}, !1 );
		});
...
/* "passive" が使えるかどうかを検出 */
var luxePassiveSupported = !1;
try {
	w.addEventListener( "test", null,
		Object.defineProperty({}, "passive", {
			get: function () {
				luxePassiveSupported = !0;
			},
		})
	);
} catch(e) {}
...
var luxeListenScroll = function(e) {
	...
	*/
    	w.addEventListener( "scroll", e, !!luxePassiveSupported && { passive: !0 } );
	w.addEventListener( "touchmove", e, !!luxePassiveSupported && { passive: !0 } );
	...
	*/
    	w.removeEventListener( "scroll", e, !!luxePassiveSupported && { passive: !0 } );
	w.removeEventListener( "touchmove", e, !!luxePassiveSupported && { passive: !0 } );
}, luxeGetStyleValue = function(e, t) {
	// Get CSS
	return e && t ? w.getComputedStyle(e).getPropertyValue(t) : null
