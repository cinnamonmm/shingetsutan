		...
		add_filter( 'comment_form_default_fields', function( $fields ) use( $luxe ) {
			...
			$fields += array(
				'captcha' => '<p class="comment-form-captcha">' . __( 'Captcha', 'luxeritas' ) . ' <span class="required">*</span></p>' .
					     ...
					     '<a href="#" onclick="document.getElementById' . "('captcha')" . '.src = ' . "'" . TDEL . '/captcha.php?' . $get_pram . "&'" . ' + Math.random(); return false"><i class="' . $awesome['fas'] . $fa_refresh . '" aria-label="Captcha code" style="font-size:32px;margin-left:10px;vertical-align:middle"></i></a></p>' .
